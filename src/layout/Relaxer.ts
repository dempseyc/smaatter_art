...
export class Relaxer {
    private static readonly DEFAULT_SPRINGS: SpringSettings = {
        ...
        minLength: 5,
        maxLength: 100,
        targetLength: 0 // 0 means use average
    };
     ...
     * N0 (root) can move.
     */
    static relax(graph: Graph, iterations: number = 50, springs: SpringSettings = this.DEFAULT_SPRINGS): void {
        const avgLength = springs.targetLength > 0 ? springs.targetLength : this.calculateAverageEdgeLength(graph);
